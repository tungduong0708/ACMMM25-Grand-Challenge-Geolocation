...
class G3(torch.nn.Module):
    def __init__(self, device, positional_encoding_type='sh', neural_network_type='siren', hparams=None):
        ...
        self.location_encoder = LocationEncoder(positional_encoding_type=positional_encoding_type.split('_')[0], neural_network_type=neural_network_type, hparams=hparams, device=device) # output batch_size, 3, 512
